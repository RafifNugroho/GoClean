...
void layerLogin() {
    system("cls");
    cout << "\n--- Halaman Login ---\n";
    cout << "Pilih Role Login (1. Pelanggan, 2. Cleaner): ";
    ...
    for (int i = 0; i < jumlahAkun; i++) {
        // Cek kecocokan Email, Username, Password, dan Role sekaligus
    ...
    if (loginBerhasil) {
        cout << "\nLogin Berhasil!\n";
        system("pause");
        // Karena usernameLogin sudah diinput saat login, kita langsung lempar ke menu
